...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = '../../../bin/Emscripten/GameAI/GameAI.data';
      var REMOTE_PACKAGE_BASE = 'GameAI.data';
...
Module['FS_createPath']("/assets", "fonts", true, true);
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_../../../bin/Emscripten/GameAI/GameAI.data');

      };
      Module['addRunDependency']('datafile_../../../bin/Emscripten/GameAI/GameAI.data');
   ...
   loadPackage({"files": [{"filename": "/assets/.gitkeep", "start": 0, "end": 0, "audio": 0}, {"filename": "/assets/fonts/DelaGothicOne-Regular-OFL.txt", "start": 0, "end": 4391, "audio": 0}, {"filename": "/assets/fonts/DelaGothicOne-Regular.ttf", "start": 4391, "end": 5454727, "audio": 0}], "remote_package_size": 5454727, "package_uuid": "c714a7da-593f-44ea-8b59-0f9c27978eb0"});
